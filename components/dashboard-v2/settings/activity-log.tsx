...
import { KeyRound, FileText, User, Mic, SlidersHorizontal } from "lucide-react";

const events = [
  { icon: KeyRound, title: "Password Changed", time: "2 months ago" },
  { icon: FileText, title: "Resume Updated", time: "3 weeks ago" },
  { icon: User, title: "Profile Edited", time: "5 days ago" },
  { icon: Mic, title: "Interview Completed", time: "6 days ago" },
  { icon: SlidersHorizontal, title: "Settings Updated", time: "Just now" },
];
