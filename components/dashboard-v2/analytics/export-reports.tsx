...
import { FileDown, FileSpreadsheet, Share2, Sparkles } from "lucide-react";

const actions = [
  { icon: FileDown, label: "Download PDF" },
  { icon: FileSpreadsheet, label: "Download CSV" },
...
export default function ExportReports() {
  return (
    <section className="mt-8 rounded-[24px] border border-neutral-200 bg-white p-5 sm:p-6 lg:rounded-[30px]">
      <h2 className="text-xl font-bold sm:text-2xl">Export Reports</h2>
