...
import { FileText, Mic, Send, Trophy, Sparkles } from "lucide-react";

const events = [
  { icon: FileText, title: "Resume Score Improved to 82", time: "2 hours ago" },
  { icon: Mic, title: "Mock Interview Completed", time: "1 day ago" },
  { icon: Send, title: "Applied to 3 New Jobs", time: "1 day ago" },
  { icon: Sparkles, title: "New AI Insights Generated", time: "2 days ago" },
  { icon: Trophy, title: "Achievement Unlocked: Consistency Champion", time: "3 days ago" },
];
